...
namespace FactorioWiki
{
    internal class BasicMaterials
    {
        ...
        public readonly static FactorioItem Oil = new FactorioItem("Нефть", "Выкачивается нефтяной вышкой из нефтяных пятен.", "Сырая нефть - неисчерпаемый природный ресурс, так же как и воду - её нельзя добывать игровым персонажем напрямую. Транспортировка осуществляется с помощью труб и / или подземных труб, бочек и вагонов - цистерн. Резервуар позволяет хранить до 25000 единиц нефти.", 0, Factory.OilZavodL, "Crude_oil.png");
        ...
        public readonly static FactorioItem Putin = new FactorioItem("Нефтяной газ", "Получается при очистке сырой нефти на нефтеперерабатывающем заводе", "Попутный нефтяной газ - один из нефтепродуктов, который получается в результате очистки сырой Нефти на Нефтеочистительном заводе. Нефтяной газ можно использовать для производства Твёрдого топлива, обладающего более высокими энергетическими показателями, нежели у Древесины и Угля.", 0, Factory.OilZavodL, "Petroleum_gas.png");

        public readonly static FactorioItem Smazka = new FactorioItem("Смазка", "Создается в химическом заводе из тяжёлой нефти", "Смазочная жидкость - материал, изготовляемый из мазута на химическом заводе. Используется при создании подземного и наземного экспресс конвейера, электродвигателя. Для изготовления необходимо провести исследование: Переработка нефти.", 1, Factory.XimZavodL, "Lubricant.png", (1, Mazut));
        ...
        public readonly static FactorioItem Sera = new FactorioItem("Сера", "Создается в химическом заводе из попутного нефтяного газа и воды", "Сера - продвинутый материал для производства. Используется для производства серной кислоты и взрывчатки.Для изготовления необходимо провести исследование: Обработка серы.", 1, Factory.XimZavodL, "Sulfur.png", (3, Water), (3, Putin));
        ...
        public readonly static FactorioItem Batery = new FactorioItem("Батарейка", "Создается на химическом заводе из серной кислоты, медной и железной плит", "Аккумулятор - ключевой компонент, используемый в создании в создании каркаса дрона, лазерных турелей и исследовательского пакета 3.Для изготовления необходимо провести исследование: Аккумулятор.", 5, Factory.XimZavodL, "Battery.png", (1, IronList), (1, CopperList), (2, ToxicSera));

        public readonly static FactorioItem Cxema = new FactorioItem("Электронные схемы", "Создается из медных кабелей и железных листов", "Электросхема является базовым компонентом во многих рецептах. Оптимальной линией для сборки является: 3 сборочных автомата для производства медных кабелей и 2 - для электросхем.", 0.5, Factory.AllVerstacs, "Electronic_circuit.png", (1, IronList), (3, CopperList));
