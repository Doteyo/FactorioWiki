...
namespace FactorioWiki
{
	public class Pack
	{
		...
		public  static FactorioItem Pack2 = new FactorioItem("Логистический исследовательский пакет", "", "Логистический исследовательский пакет - пакет второго уровня, используемый для исследования технологий в лабораториях. Оптимальная автомататизация: 2 сборочных автомата для производства манипуляторов и 1 - для конвейеров на 24 автомата для производства исследовательских пакетов.", 6, Factories.AllVerstacs, null, "", (1, Manipulator.Yellow), (1, ResourceDelivery.Conveer));
